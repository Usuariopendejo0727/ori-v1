...
async def run_test():
    ...
    try:
        ...
        # -> Type the login email into the email field and the password into the password field, then submit the login form.
        ...
        # -> Click 'API y Modelo' in the main navigation (interactive element index 859).
        frame = context.pages[-1]
        # Click element
