...
async def run_test():
    ...
    try:
        ...
        # -> Type the login email into the email field (index 49), then type the password into the password field (index 57), then click the login button (index 62).
        ...
        # -> Click on 'API y Modelo' in the main navigation to open the API configuration page.
        frame = context.pages[-1]
        # Click element
        ...
        await expect(frame.locator('text=API key').first).to_be_visible(timeout=3000)
