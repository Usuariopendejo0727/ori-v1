...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email field (input index 4).
        ...
        # -> Click the 'API y Modelo' link in the sidebar to open the API configuration page (element index 163).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/nav/a[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the 'API y Modelo' link in the sidebar (use interactive element index 862).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/nav/a[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        await expect(frame.locator('text=modelo').first).to_be_visible(timeout=3000)
